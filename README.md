...
## Project Overview
A comprehensive end-to-end automation suite designed for the automotive supply chain. This suite streamlines the logistics data: automated key in web address -> unstructured PDF parsing data -> cost trend analysis.
